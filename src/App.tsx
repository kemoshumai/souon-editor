...
import MetadataWindow from "./HeaderController/MetadataWindow";
  ...
  return (
    <>
      <Theme appearance="dark">
        ...
        <Moca />
        {snap.rouletteWindow && (
          <RouletteWindow onClose={() => (store.rouletteWindow = false)} />
        )}
        {snap.metadataWindow && (
          <MetadataWindow onClose={() => (store.metadataWindow = false)} />
        )}
      </Theme>
    </>
  );
